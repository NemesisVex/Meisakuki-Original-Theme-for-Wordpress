...
<head>
	...
	<![endif]-->
	<?php wp_head(); ?>
	<link rel="stylesheet" href="<?php echo meisakuki_get_cdn_uri(); ?>/web/css/blueprint/screen.css" type="text/css" media="screen, projection" />
	<link rel="stylesheet" href="<?php echo meisakuki_get_cdn_uri(); ?>/web/css/blueprint/print.css" type="text/css" media="print" />
	<!--[if lt IE 8]><link rel="stylesheet" href="<?php echo meisakuki_get_cdn_uri(); ?>/web/css/blueprint/ie.css" type="text/css" media="screen, projection" /><![endif]-->
